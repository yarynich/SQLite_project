...
// (DO NOT EDIT: machine generated header) 'VirtualTrees.Utils.pas' rev: 34.00 (Windows)
...
extern DELPHI_PACKAGE bool __fastcall IsMouseCursorVisible(void);
extern DELPHI_PACKAGE void __fastcall ScaleImageList(Vcl::Controls::TImageList* const ImgList, int M, int D);
extern DELPHI_PACKAGE bool __fastcall IsHighContrastEnabled(void);
}	/* namespace Utils */
}	/* namespace Virtualtrees */
